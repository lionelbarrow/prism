...
describe Prism::StackTraceGenerator do
  ...
  describe "enable!" do
    it "turns on the trace function" do
      ...
      tracer = Prism::StackTraceGenerator.new(@project_root)
  ...
  describe "stack_trace" do
    ...
    it "applies filters to the stack trace" do
      tracer = Prism::StackTraceGenerator.new(@project_root, BadFilter)
      object = TestClass.new
  ...
  describe "initialize" do
    ...
    it "accepts a variable number of arguments" do
      tracer = Prism::StackTraceGenerator.new(@project_root, BadFilter, BadFilter)
